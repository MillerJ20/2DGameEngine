...
std::tuple<double, double> GetEntityPosition(Entity entity) {
  if (entity.HasComponent<TransformComponent>()) {
    ...
    Logger::Err("Trying to get the position of an entity that has no transform "
                "component");
...
std::tuple<double, double> GetEntityVelocity(Entity entity) {
  if (entity.HasComponent<RigidBodyComponent>()) {
    ...
    Logger::Err("Trying to get the velocity of an entity that has no rigidbody "
                "component");
    return std::make_tuple(0.0, 0.0);
  }
}
...
void SetEntityPosition(Entity entity, double x, double y) {
  if (entity.HasComponent<TransformComponent>()) {
    ...
    Logger::Err("Trying to set the position of an entity that has no transform "
                "component");
  }
}
...
void SetEntityVelocity(Entity entity, double x, double y) {
  if (entity.HasComponent<RigidBodyComponent>()) {
    ...
    Logger::Err("Trying to set the velocity of an entity that has no rigidbody "
                "component");
  }
}
...
void SetEntityRotation(Entity entity, double angle) {
  if (entity.HasComponent<TransformComponent>()) {
    ...
    Logger::Err("Trying to set the rotation of an entity that has no transform "
                "component");
  }
}
...
void SetEntityAnimationFrame(Entity entity, int frame) {
  if (entity.HasComponent<AnimationComponent>()) {
    ...
    Logger::Err("Trying to set the animation frame of an entity that has no "
                "animation component");
  }
}
...
void SetProjectileVelocity(Entity entity, double x, double y) {
  if (entity.HasComponent<ProjectileEmitterComponent>()) {
    ...
    Logger::Err("Trying to set the projectile velocity of an entity that has "
                "no projectile emitter component");
  }
}
